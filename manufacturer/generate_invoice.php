...
include("translate.php");
	...
	if(isset($_SESSION['manufacturer_login'])) {
		if(isset($_SESSION['manufacturer_login']) == true) {
			...
			$query_selectInvoiceId = "SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'smartbusiness' AND TABLE_NAME = 'invoice'";
...
<head>
	...
	<link rel="stylesheet" href="../includes/main_style_sto.css" >
</head>
<body>
	<?php
