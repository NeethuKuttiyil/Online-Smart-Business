...
<?php include_once('includes/header.php');?>
 ...
 <?php $query=mysqli_query($con,"Select * from retailer");
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    ...
                                                    <p class="text-muted mb-0 mt-2">Total Registered Retailer</p>
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Total Products</p>
...
<div class="card-box mb-0 widget-chart-two">
<div class="float-right">
<?php $query2=mysqli_query($con,"Select * from invoice");
...
?>
                                                ...
                                                <div class="widget-chart-two-content">
                                                    <p class="text-muted mb-0 mt-2">Total Invoice</p>
...
?>
        ...
        <!-- Dashboard Init -->
        <script src="assets1/pages/jquery.dashboard.init.js"></script>
