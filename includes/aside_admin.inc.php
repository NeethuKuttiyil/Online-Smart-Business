...
<aside>
	...
	--><a href="../admin/add_manufacturer.php">Add Stockiest</a><!--
...
<a href="../index.html"><input type="button" value="Log out" class="submit_button" style="float:right;margin:10px;"/></a>
