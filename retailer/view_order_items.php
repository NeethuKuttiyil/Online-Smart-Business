...
<head>
	...
	<link rel="stylesheet" href="../includes/main_style_ret.css" >
</head>
<body>
	<?php
	...
	<section>
		...
		<center>
		<input type="button" value="Payment" class="submit_button" onclick="window.location.href='credit-card-validation-with-card-js/dist/index.html'"/>
		</center>
